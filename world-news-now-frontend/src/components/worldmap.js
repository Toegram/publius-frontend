...
//   }
//
//   selectCountryAndFetchNews = (event) => {
//     this.props.selectCountry(event, this.props.getNewsArticles)
...
//     <div>
//
//     <div style={wrapperStyles} onClick={(event) => this.selectCountryAndFetchNews(event)} >
//
//       <ComposableMap
//         projectionConfig={{
//           scale: 205,
